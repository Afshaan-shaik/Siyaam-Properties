...
export default function DubaiOverseas() {
  ...
  return (
    <section id="dubai" className="relative py-24 bg-obsidian-950 border-t border-white/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900 border border-gold-500/40 text-xs font-bold text-gold-300 tracking-wider uppercase font-heading">
            <Globe2 className="w-3.5 h-3.5 text-gold-400" />
            <span>GLOBAL INVESTMENT ADVISORY • DUBAI UAE</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white font-heading tracking-tight">
            Unlock Tax-Free Wealth in <span className="text-gradient-gold">Dubai</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-16">
          ...
          <div className="lg:col-span-6 glass-card rounded-3xl p-8 border border-white/10 space-y-6 relative overflow-hidden bg-gradient-to-br from-obsidian-900 via-slate-900 to-obsidian-950">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4">
              <a
                href="https://wa.me/918884969988?text=Hello%20Sameer%20ji,%20I%20am%20interested%20in%20tax-free%20Dubai%20property%20investments%20with%20Amniyat."
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-xs text-obsidian-950 bg-gold-400 hover:bg-gold-300 transition-colors shadow-lg"
              >
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {benefits.map((b, idx) => {
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-gold-400/10 border border-gold-500/20 text-gold-400 flex items-center justify-center mb-4">
